...
{
    public class strchr_Tests : MajorbbsTestBase
    {
        ...
        public void strchrTest(string a, char toFind, string expected)
        {
            ...
            //Execute Test
            ExecuteApiTest(STRCHR_ORDINAL, new List<ushort> {strPointer.Offset, strPointer.Segment, toFind});
            ...
            else
            {
              ...
              var returnString = mbbsEmuMemoryCore.GetString(new IntPtr16(mbbsEmuCpuRegisters.DX, mbbsEmuCpuRegisters.AX), /* stripNull= */ true);
