...
{
    public class FCOMP_Tests : CpuTestBase
    {
        ...
        public void FCOMP_ST1_Test(double ST0Value, double ST1Value, ushort expectedFlags)
        {
            Reset();
        ...
        public void FCOMP_M32_Test(double ST0Value, float m32Value, ushort expectedFlags)
        {
            ...
            var instructions = new Assembler(16);
            instructions.fcomp(__dword_ptr[0]);
            CreateCodeSegment(instructions);
        ...
        public void FCOMP_M64_Test(double ST0Value, double m32Value, ushort expectedFlags)
        {
            ...
            var instructions = new Assembler(16);
            instructions.fcomp(__qword_ptr[0]);
            CreateCodeSegment(instructions);
