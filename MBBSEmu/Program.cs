        ...
        if (!string.IsNullOrEmpty(_modulePath) && string.IsNullOrEmpty(_moduleIdentifier)) {
          ...
          foreach (var file in Directory.GetFiles(_modulePath, "*.MDF")) {
            ...
            _moduleConfigurations.Add(
                new ModuleConfiguration { ModuleIdentifier = moduleIdentifier,
                                          ModulePath = _modulePath, ModuleEnabled = true,
          ...
          // Load Command Line
          _moduleConfigurations.Add(new ModuleConfiguration { ModuleIdentifier = _moduleIdentifier,
