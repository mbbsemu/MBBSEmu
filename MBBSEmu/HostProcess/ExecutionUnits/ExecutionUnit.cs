...
namespace MBBSEmu.HostProcess.ExecutionUnits
{
    ...
    public class ExecutionUnit
    {
        ...
        public ExecutionUnit(IMemoryCore moduleMemory, IClock clock, IFileUtility fileUtility, Dictionary<ushort, IExportedModule> exportedModuleDictionary, ILogger logger, string path)
        {
            ...
            ModuleCpu.Reset(ModuleMemory, ExternalFunctionDelegate, new List<IInterruptHandler> { new Int21h(ModuleCpuRegisters, ModuleMemory, clock, logger, fileUtility, null, null, new TextWriterStream(Console.Error), path), new Int3Eh(), new Int1Ah(ModuleCpuRegisters, ModuleMemory, clock) });
        }
