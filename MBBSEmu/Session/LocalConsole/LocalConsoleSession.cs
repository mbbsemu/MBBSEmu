...
namespace MBBSEmu.Session.LocalConsole
{
    ...
    public class LocalConsoleSession : SessionBase
    {
        ...
        public LocalConsoleSession(ILogger logger, string sessionId, IMbbsHost host, AppSettings configuration, ITextVariableService textVariableService) : base(host, sessionId, EnumSessionState.Unauthenticated, configuration, textVariableService)
        {
            _logger = logger;
            _host = host;
